  ...
  methods: {
    getOrderDetail() {
      this.axios.get(`/orders/${this.orderNo}`).then((res) => {
        ...
        this.addressInfo = `${receiverName} ${receiverMobile} ${receiverZip} ${receiverProvince} ${receiverCity} ${receiverDistrict} ${receiverAddress}`;
      });
    },
    paySubmit(payType) {
        ...
        this.axios
          ...
          .then((res) => {
            QRCode.toDataURL(res.content)
              ...
              .catch(() => {
                this.$message.err("微信支付二维码生成失败，请稍后重试");
              });
          });
      }
    },
